	...
	return (
		<section className="max-w-4xl mx-auto space-y-4 py-10">
			...
			<p className="text-base">
				Interested in working together or just want to chat about tech? Reach
				out!
			</p>
			<div className="flex gap-3 items-center">
				<span className="flex gap-2 items-center bg-surface-muted p-2 text-text-muted rounded-lg border border-border">
					<SiMailgun size={14} />
